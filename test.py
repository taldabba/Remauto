...
class MyController(Controller):
   ...
   ################# TURN SIGNAL FUNCTIONS #################  
    def on_L1_press(self):
        print("LEFT TURN SIGNAL ENGAGED")
    def on_L1_release(self):
        print("LEFT TURN SIGNAL DISENGAGED")
    def on_R1_press(self):
        print("RIGHT TURN SIGNAL ENGAGED")
    def on_R1_release(self):
        print("RIGHT TURN SIGNAL DISENGAGED")
   #######################################$#################  
   ...
   ############## STEERING WHEEL FUNCTIONS #################  
    def on_L3_left(self, value):
        print("STEER LEFT: {}%".format(mapRangePS4Value(value)))
    def on_L3_right(self, value):
        print("STEER RIGHT: {}%".format(mapRangePS4Value(value)))
   ...
   ################# GEAR SHIFT MENU #################  
    def on_options_press(self):
        print("GEAR SHIFT MENU OPENED")
    def on_options_release(self):
        print("GEAR SHIFT MENU CLOSED")
   ###################################################  
